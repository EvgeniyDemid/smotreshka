...
public class CinemaPage {
	...
	private final SelenideElement yearMoviePremier = $(By.xpath("//div[@class='title-details-info-with-icon year mr-32 dark']"));
	private final SelenideElement countryMoviePremier = $(By.xpath("//div[@class='title-details-info-with-icon country mr-32 dark']"));
	private final SelenideElement categoriesMoviePremier = $(By.xpath("(//div[@class='categories title-details-info vod light']/span)[2]"));
	private final SelenideElement genresMoviePremier = $(By.xpath("(//div[@class='genres title-details-info vod light']/span)[2]"));
	private final SelenideElement ageMoviePremier = $(".age");
	private final SelenideElement descriptionMoviePremier = $(By.xpath("//div[@class='text-with-truncation light body1']/div"));
